# Generated by Powerlevel10k configuration wizard on 2026-05-06 at 21:42 CEST.
...
() {
  ...
  # Keep the right side quiet: show only actionable state and the active Python environment.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    status
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%F{#A4133C}─╮%f'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%F{#A4133C}─┤%f'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%F{#A4133C}─╯%f'
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND='#A4133C'
